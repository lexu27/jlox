...
class Interpreter implements Expr.Visitor<Object>, Stmt.Visitor<Void> {
    ...
    public Object visitSuperExpr(Expr.Super expr) {
        ...
        LoxInstance object = (LoxInstance) environment.getAt(distance - 1, "this"); // This is
                                                                                    // located one
                                                                                    // right before
                                                                                    // super.
    ...
    public Object visitUnaryExpr(Expr.Unary expr) {
        ...
        switch (expr.operator.type) {
            case MINUS:
                ...
                return -(double) right; // What if cast fails?
            case BANG:
    ...
    public Object visitBinaryExpr(Expr.Binary expr) {
        ...
        switch (expr.operator.type) { // Implicitly evaluates from left to right
            case MINUS:
    ...
    private boolean isTruthy(Object object) {
        ...
        if (object instanceof Boolean)
            return (boolean) object; // Use Java type system to infer types at runtime
        return true; // Everythign else is true!
    }
    ...
    private boolean isEqual(Object a, Object b) {
        ...
        if (a == null)
            return false;
        return a.equals(b); // Makes lox's version of equality tied to java
    }
    ...
    public Object visitAssignExpr(Expr.Assign expr) { // Returns since assignment is an expression.
        Object value = evaluate(expr.value); // Evaluate the r-value
